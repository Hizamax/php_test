<?php
	...
	$sql="select * from schematch where day > now()";
...
<html>
	...
	<body>
		...
		<?php
			echo '<div id="search">
				<form action="search.php" method="get" id="club-op">
					<label for="opponent">クラブチーム名(対戦相手)(順位順)</label>
					<select name="opponent">
						<option value="アトレティコ">アトレティコ</option>
						<option value="レアルマドリード">レアルマドリード</option>
						<option value="レアルソシエダ">レアルソシエダ</option>
						<option value="ビジャレアル">ビジャレアル</option>
						<option value="セビージャ">セビージャ</option>
						<option value="グラナダ">グラナダ</option>
						<option value="セルタ">セルタ</option>
						<option value="ビルバオ">ビルバオ</option>
						<option value="カディス">カディス</option>
						<option value="ベティス">ベティス</option>
						<option value="エイバル">エイバル</option>
						<option value="レバンテ">レバンテ</option>
						<option value="アラベス">アラベス</option>
						<option value="バリャドリード">バリャドリード</option>
						<option value="ヘタフェ">ヘタフェ</option>
						<option value="バレンシア">バレンシア</option>
						<option value="エルチェ">エルチェ</option>
						<option value="オサスナ">オサスナ</option>
						<option value="ウエスカ">ウエスカ</option>
					</select>
					<input type="hidden" name="id" value="'.$id.'">
					<input type="submit" class="btn_s" value="検索">
				</form>
			</div>';
		?>
		<table border="1" id="sche-table">
			<?php
