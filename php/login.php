...
<html>
	...
	<body>
		<p id="login_p">下記のフォームに入力してログインしてください</p>
		<div class="menu">
			<img src="../img/img-studium.jpg"  alt="studium" width="100%" height="500">
		</div>
		<div id="login-whole">
			<form id="login" action="home.php" method="post">
				<table border="3" id="logintable">
					<tr>
						<th><label for="userid">ユーザID</label></th>
						<td><input type="text" class="form-group-log" id="userid" name="userid" required></td>
					</tr>
					<tr>
						<th><label for="password">パスワード</label></th>
						<td><input type="password" class="form-group-log" id="password" name="password" required></td>
					</tr>
				</table>
				<input type="submit" value="決定" class="touroku">
			</form>
		</div>
		<div class="footer">
			<div class="footer1">
